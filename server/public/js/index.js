    ...
    */
    ...
    _createClass(Lottery, [{
        ...
        value: function initEvent() {
            ...
            (0, _jquery2.default)('.dxjo').on('click', 'li', self.assisHandle.bind(self));
            (0, _jquery2.default)('.qkmethod').on('click', '.btn-middle', self.getRandomCode.bind(self));
        }
    }]);

    return Lottery;
}(mix(_timer2.default, _calculate2.default, _interface2.default, _base2.default));
    ...
    _createClass(Timer, [{
        ...
        value: function countdown(end, update, handle) {
            ...
            if (now - end > 0) {
                ...
                var px_h = 1000 * 60 * 60; //一小时的毫秒
                var px_m = 1000 * 60; //一分钟的毫秒
                var px_s = 1000;
                //剩余时间包含多少天
